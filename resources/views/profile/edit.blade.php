...
<head>
    <meta charset="utf-8">
    <title>Likho | Edit Profile</title>
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center mb-3">
                                    <img src="{{ $user->profile_photo_url }}" alt="{{ $user->name }}'s Profile Picture" class="author-image rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                                </div>
